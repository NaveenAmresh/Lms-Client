...
export class BookListComponent implements OnInit {
  print: ExportAsConfig = {type: 'pdf', elementId: 'table'}; text: ExportAsConfig = {type: 'doc', elementId: 'table'};  f1: string = 'A';
  ...
  constructor(public dialog: MatDialog, private _get: ListBooksService, private exportAsService: ExportAsService,
